...
public:
  ...
  Temperature_LM75_Derived(I2C_HandleTypeDef *bus, uint8_t i2c_address, Attributes *attributes) {
    this->bus = bus;
...
public:
  ...
  Generic_LM75_Compatible(I2C_HandleTypeDef *bus, uint8_t i2c_address, Attributes *attributes)
...
public:
  Generic_LM75(I2C_HandleTypeDef *bus, uint8_t i2c_address = DEFAULT_I2C_ADDRESS)
...
public:
  Generic_LM75_10Bit(I2C_HandleTypeDef *bus, uint8_t i2c_address = DEFAULT_I2C_ADDRESS)
...
public:
  Generic_LM75_11Bit(I2C_HandleTypeDef *bus, uint8_t i2c_address = DEFAULT_I2C_ADDRESS)
...
public:
  Generic_LM75_12Bit(I2C_HandleTypeDef *bus, uint8_t i2c_address = DEFAULT_I2C_ADDRESS)
...
public:
  ...
  Generic_LM75_9_to_12Bit_Compatible(I2C_HandleTypeDef *bus, uint8_t i2c_address, Attributes *attributes)
...
public:
  Generic_LM75_9_to_12Bit(I2C_HandleTypeDef *bus, uint8_t i2c_address = DEFAULT_I2C_ADDRESS)
...
class OnSemi_NCTx75 : public Generic_LM75_12Bit {
  ...
  public:
  OnSemi_NCTx75(I2C_HandleTypeDef *bus, uint8_t i2c_address = DEFAULT_I2C_ADDRESS)
...
public:
  ...
  Generic_LM75_9_to_12Bit_OneShot_Compatible(I2C_HandleTypeDef *bus, uint8_t i2c_address, Attributes *attributes)
...
public:
  Generic_LM75_9_to_12Bit_OneShot(I2C_HandleTypeDef *bus, uint8_t i2c_address = DEFAULT_I2C_ADDRESS)
...
public:
  ...
  TI_TMP102_Compatible(I2C_HandleTypeDef *bus, uint8_t i2c_address = DEFAULT_I2C_ADDRESS)
